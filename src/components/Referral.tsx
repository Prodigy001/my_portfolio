  ...
  return (
    <div className="bg-[#EBF0FF] shadow-[0px_1.25px_4px_0px_rgba(26,26,26,0.08)] overflow-hidden rounded-xl">
      <header className="flex items-center justify-between gap-4 p-4 bg-[#7099FF]">
        ...
        <button className="inline-flex items-center text-white gap-1.5 px-3 py-0.5 border border-zabira-dark/12  rounded-[50px] text-sm leading-5.5 font-semibold shadow-[0px_1px_2px_0px_rgba(26,26,26,0.08)] bg-zabira-dark/26">
          Referral Code
          <IconCopy />
        </button>
      </header>
