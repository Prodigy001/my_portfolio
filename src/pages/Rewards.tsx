  ...
  return (
    <main>
      <section className="bg-white rounded-2xl p-6 mb-6">
        <h1 className="font-bold text-2xl text-[#1A1A1A] mb-2">Rewards</h1>
        <p className="text-[#1A1A1A5C] text-base">
          Earn and redeem rewards from your transactions
        </p>
      </section>
      ...
      <section className="bg-white rounded-2xl p-6">
        <div className="h-96 flex items-center justify-center">
          <div className="text-center">
            <p className="text-[#1A1A1A5C] text-lg mb-4">Rewards content</p>
