  ...
  return (
    <main>
      <section className="bg-white rounded-2xl p-6 mb-6">
        <h1 className="font-bold text-2xl text-[#1A1A1A] mb-2">Giftcard</h1>
        <p className="text-[#1A1A1A5C] text-base">
          Buy and sell giftcards from popular retailers
        </p>
      </section>
      ...
      <section className="bg-white rounded-2xl p-6">
        <div className="h-96 flex items-center justify-center">
          <div className="text-center">
            <p className="text-[#1A1A1A5C] text-lg mb-4">Giftcard content</p>
